...
class Program
{
    static void Main()
    {
        try
        {
            //RationalNumber ratnum = new RationalNumber(0, 1);
            ...
            while (true)
            {
                ...
                Console.WriteLine("6 - To compare with rational number");
                Console.WriteLine("7 - Change string format");
