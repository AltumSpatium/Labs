...
ADD crew INT DEFAULT NULL,
ADD FOREIGN KEY (crew) REFERENCES crew (crewID) ON UPDATE CASCADE,
ADD plane INT DEFAULT NULL,
ADD FOREIGN KEY (plane) REFERENCES aircraft (planeID) ON UPDATE CASCADE;
